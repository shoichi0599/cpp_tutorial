...
int main() {
    ...
    // It is good idea to extract condition to variable for readability if it's complex
    bool condition1 = (value2 != 8) && (value1 == 10);
    bool condition2 = value1 < 10;
    cout << "(value2 != 8) && (value1 == 10): " << condition1 << endl;
    cout << "value1 < 10: " << condition2 << endl;
